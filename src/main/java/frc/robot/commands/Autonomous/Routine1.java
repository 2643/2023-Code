...
public class Routine1 extends SequentialCommandGroup {
    ...
    //     addCommands(swerveControllerCommand);
        ...
        addCommands(new Odometry(new Pose2d(new Translation2d(14.596, 0.407), new Rotation2d(0))), 
        new Odometry(new Pose2d(new Translation2d(11.172, 0.407), new Rotation2d(0))), 
