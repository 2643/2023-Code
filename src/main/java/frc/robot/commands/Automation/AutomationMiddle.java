...
public class AutomationMiddle extends SequentialCommandGroup {
  ...
  //List<Pose2d> poses = new ArrayList<>();
    ...
    if (DriverStation.getAlliance() == Alliance.Red) {
      if (RobotContainer.m_grabber.getArmGrabState() != States.CLOSED && RobotContainer.m_grabber.getArmGrabState() != States.CLOSING_CURRENT && RobotContainer.m_grabber.getArmGrabState() != States.CLOSING_STARTING_VELOCITY && RobotContainer.m_grabber.getArmGrabState() == States.CLOSING_TIME_ELAPSING) {
        for (int i = 0; i < 100; i++) {
          System.out.println("RED PICKUP CALLED");
        }
        ...
        if(RobotContainer.coneMode.getAsBoolean()) {
          for (int i = 0; i < 100; i++) {
            System.out.println("RED CONE CALLED");
          }
      ...
      if (RobotContainer.m_grabber.getArmGrabState() != States.CLOSED && RobotContainer.m_grabber.getArmGrabState() != States.CLOSING_CURRENT && RobotContainer.m_grabber.getArmGrabState() != States.CLOSING_STARTING_VELOCITY && RobotContainer.m_grabber.getArmGrabState() == States.CLOSING_TIME_ELAPSING) {
        for (int i = 0; i < 100; i++) {
          System.out.println("BLUE PICKUP CALLED");
        }
        ...
        if (RobotContainer.coneMode.getAsBoolean()) {
          for (int i = 0; i < 100; i++) {
            System.out.println("BLUE CONE CALLED");
          }
          ...
          for (int i = 0; i < 100; i++) {
            System.out.println("BLUE CUBE CALLED");
          }
      ...
      for (int i = 0; i < 100; i++) {
        System.out.println("WHY ARE YOU CALLED");
      }
