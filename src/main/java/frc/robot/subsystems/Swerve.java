...
public class Swerve extends SubsystemBase {
  ...
  SwerveDrivePoseEstimator visionRobotPos = new SwerveDrivePoseEstimator(m_kinematics, gyroAngle(), pos, robotPosition);
  ...
  public Swerve() {
    ...
    imu.configMountPose(AxisDirection.PositiveX, AxisDirection.PositiveY);
    imu.configMountPose(0, 0, 0);
    //imu.setYaw(0);
    m_odometry.resetPosition(new Rotation2d(0), pos, robotPosition);
    visionRobotPos.addVisionMeasurement(RobotContainer.m_vision.robotPos.get().estimatedPose.toPose2d(), 1);
  ...
  public void periodic() {
    ...
    // if(RobotContainer.m_vision.result.hasTargets())
    //   visionRobotPos.addVisionMeasurement(RobotContainer.m_vision.photonPoseEstimator.getReferencePose().toPose2d(), 1);
