...
public final class Constants {
    ...
    public static final double  AUTONOMOUS_ENDING_LOCATION_ONE = 0;
    public static final double  AUTONOMOUS_ENDING_LOCATION_TWO = 0;
    public static final double  AUTONOMOUS_ENDING_LOCATION_THREE = 0;
    public static final double  AUTONOMOUS_ENDING_LOCATION_FOUR = 0;
